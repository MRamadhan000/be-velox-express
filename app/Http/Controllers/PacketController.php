...
class PacketController extends Controller
{
    ...
    public function update(Request $request, $id) {
        try {
            ...
            $packet->update([
                'sender_name' => $request->sender_name ?? $packet->sender_name,
                'sender_phone' => $request->sender_phone ?? $packet->sender_phone,
                'pickup_address' => $request->pickup_address ?? $packet->pickup_address,
                'receiver_name' => $request->receiver_name ?? $packet->receiver_name,
                'receiver_phone' => $request->receiver_phone ?? $packet->receiver_phone,
                'destination_address' => $request->destination_address ?? $packet->destination_address,
                'weight' => $request->weight ?? $packet->weight,
                'packet_image' => $path
            ]);
